...
AT_NONCACHEABLE_SECTION_INIT(uint8_t pca9685_txBuff[8]);
AT_NONCACHEABLE_SECTION_INIT(uint8_t pca9685_rxBuff[8]);
...
void pca9685_sleep(PCA9685 *pca9685_module) {
	...
	pca9685_module->_delay_ms(5); // wait until cycle ends for sleep to be active
}
...
uint8_t* pca9685_getPWM(PCA9685 *pca9685_module, uint8_t num) {
  ...
  pca9685_module->_i2cwrite(pca9685_module->_i2caddr, pca9685_txBuff, 1);
  pca9685_module->_i2cread(pca9685_module->_i2caddr, pca9685_rxBuff, 4);
...
void pca9685_setPWM(PCA9685 *pca9685_module, uint8_t num, uint16_t on, uint16_t off) {
  ...
  pca9685_module->_i2cwrite(pca9685_module->_i2caddr, pca9685_txBuff, 5);
}
...
uint8_t pca9685_read8(PCA9685 *pca9685_module, uint8_t addr) {
  ...
  pca9685_module->_i2cwrite(pca9685_module->_i2caddr, pca9685_txBuff, 1);
  pca9685_module->_i2cread(pca9685_module->_i2caddr, pca9685_rxBuff, 1);
...
void pca9685_write8(PCA9685 *pca9685_module, uint8_t addr, uint8_t d) {
  ...
  pca9685_module->_i2cwrite(pca9685_module->_i2caddr, pca9685_txBuff, 2);
}

...
#define INA219_ADDRESS                         (0x40)	// 100 0000 (A0+A1=GND) default I2C address
...
typedef void (*I2C_read_t)(uint8_t addr, uint8_t * rxBuff, size_t bytestoread);
typedef void (*I2C_write_t)(uint8_t addr, uint8_t * txBuff, size_t bytestosend);
